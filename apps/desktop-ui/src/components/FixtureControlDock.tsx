  ...
  return (
    <section className="fixture-control-dock">
      ...
      <div className="fixture-dock-body">
        ...
        {tab === "beam" && <div className="beam-dock"><DockRange label="ZOOM" value={primary.zoom} onStart={capture} onChange={(zoom) => update({ zoom })} /><div className="beam-buttons"><button>Open</button><button>Strobe</button><button>Pulse</button><button>Random</button></div><p>Only controls supported by the selected fixture profile are enabled.</p></div>}
