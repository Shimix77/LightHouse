...
- Opening, creating or structurally restarting a project starts and validates its replacement headless Show Engine before the previous engine is shut down.
